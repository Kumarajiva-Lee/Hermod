...
void UpdateHalo_2d_D(ProcType Proc, double *array, AsyncType *async, bool full_lon, bool full_lat, bool west_halo, bool east_halo, bool south_halo, bool north_halo);
void UpdateHalo_3d_D(ProcType Proc, double *array, AsyncType *async, bool full_lon, bool full_lat, bool full_lev, bool west_halo, bool east_halo, bool south_halo, bool north_halo);
