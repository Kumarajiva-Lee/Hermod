...
contains
  ...
  recursive subroutine linked_list_clear(this)
  ...
  recursive subroutine linked_list_item_final(this)

    type(linked_list_item_type), intent(inout) :: this

    if (this%internal_memory .and. associated(this%value)) deallocate(this%value)

  end subroutine linked_list_item_final

  recursive subroutine linked_list_final(this)

    type(linked_list_type), intent(inout) :: this

    call this%clear()

  end subroutine linked_list_final
